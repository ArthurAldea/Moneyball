...
|---|-------|------|--------------|--------|
| 1 | FBref Scraper (EPL) | Replace Understat + API-Football with a complete FBref scraper covering all required stat tables for EPL only | DATA-01 (EPL), DATA-02, DATA-05, DATA-06, DATA-07 | 🔄 In Progress (Plans 01-01, 01-02 done) |
